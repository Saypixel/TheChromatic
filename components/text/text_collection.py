...
class TextCollection:
    ...
    def __init__(self, texts: list[Text], sign_width: int, pos: Optional[tuple[int, int]] = (320, 180)):
        self.textList = []
        self.position = pos
    ...
    def jump_to_next(self) -> bool:
        ...
        self.next = self.textList[self.index + 1] if self.index + 2 <= len(self.textList) else None
