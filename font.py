...
class Font:
    ...
    def render(font_path: str, size: int, text: str, color: tuple[int, int, int]) -> pygame.Surface | pygame.SurfaceType:
        return Font.get(font_path, size).render(text, False, color)