...
def update_menu():
    ...
    while CONFIG.is_running and not need_to_exit:
        ...
        button_play = Button(image=button_play_image, pos=(320, 250),
                                  text_input='시작', font=Font(Fonts.TITLE2, 40).to_pygame(), base_color='#ffffff',
                                  hovering_color='White')
        
        button_settings_image = pygame.image.load('assets/images/button_settings_50px.png')
        ...
        button_exit = Button(image=button_exit_image, pos=(290, 315),
                                  text_input='종료', font=Font(Fonts.TITLE2, 30).to_pygame(), base_color='#ffffff',
                                  hovering_color='White')
