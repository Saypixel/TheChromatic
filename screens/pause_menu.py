...
def update_pause_menu():
        ...
        match event.type:
            case pygame.MOUSEBUTTONDOWN:  # 마우스 클릭 시
                ...
                if button_fullscreen.check_for_input(menu_mouse_pos):  # 전체화면
                    ...
                    path = 'assets/images/button_window.png' if CONFIG.is_fullscreen else 'assets/images/button_fullscreen.png'
                ...
                if button_unmute.check_for_input(menu_mouse_pos):  # 음소거
                    path = 'assets/images/button_unmute.png' if SFX.muted else 'assets/images/button_mute.png'
                    image = pygame.image.load(path)
    ...
    while CONFIG.is_running and not need_to_exit:
        ...
        # 음소거 동기화
        path = 'assets/images/button_mute.png' if SFX.muted else 'assets/images/button_unmute.png'
        image = pygame.image.load(path)
        image = pygame.transform.scale_by(image, 0.2)
        ...
        for button in [button_play, button_settings, button_fullscreen, button_unmute, button_exit]:
